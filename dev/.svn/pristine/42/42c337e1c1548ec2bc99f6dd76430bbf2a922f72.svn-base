...
@interface EfilingRegisterSaveViewController : HeaderViewController<UITextFieldDelegate,UIAlertViewDelegate,UIGestureRecognizerDelegate,ENRegisterSaveServiceDelegate,UIPickerViewDataSource, UIPickerViewDelegate>{
...
@property (nonatomic) ENRegisterSaveService *enRegisterSaveService;
