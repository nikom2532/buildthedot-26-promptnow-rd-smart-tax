...
#define kServiceUrl @"http://kimhun55.com/llnun/TestServiceRD/mobile/register/confirmQuestion.json"

@implementation ENConfirmQuestionService{
...
//    }
    if ([NSJSONSerialization isValidJSONObject:dictionary]) {
        ...
        [susanooObject sendSecuredRequestToService:@"fg-confirm-question.service" withJSONData:postData];
    }
}
...
//    [self.delegate responseENConfirmQuestionService:receivedData]; //send the data to the delegate
//}
...
-(void)susanooConnectionDidFinish:(SusanooResponse *)response
{
    ...
    [_delegate responseENConfirmQuestionService:receivedData];
    [SVProgressHUD dismiss];
