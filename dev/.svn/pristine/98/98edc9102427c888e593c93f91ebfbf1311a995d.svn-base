...
#import "ENGetTemplate.h"
#import "JSONDictionaryExtensions.h"
#import "Util.h"
#import "SVProgressHUD.h"
#import "ShareUserDetail.h"
@implementation ENGetTemplate
{
    NSDictionary *receivedData;
}

- (void) requestENGetTemplateServiceWithValue:(NSString*)value
{
...
//    [dictionary setValue:@"" forKey:@"taxYear"];
    ...
    if ([NSJSONSerialization isValidJSONObject:dictionary]) {
        ...
        [susanooObject sendSecuredRequestToService:@"fl-get-template.service" withJSONData:postData];
    }
...
-(void)susanooConnectionDidFinish:(SusanooResponse *)response
{
    ...
    [_delegate responseENGetTemplateService:receivedData];
