...
import static com.promptnow.rdsmart.service.base.BaseService.isEmpty;
...
public class LG_Logout extends BaseService{
    ...
    public String execute(VulcanHashParameter vhp) throws VulcanException {
        try{
            ...
            if(isEmpty(reqObject.nid) || isEmpty(reqObject.sessionID)){
            ...
            UserProfileDB up = new UserProfileDB();
            up.updateUserLogoutTime(reqObject.nid, reqObject.sessionID);
