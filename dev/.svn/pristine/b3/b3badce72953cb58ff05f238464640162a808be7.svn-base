...
public class PF_Update_TaxPayerProfile extends BaseService{
    ...
    public String execute(VulcanHashParameter vhp) throws VulcanException {
        try{
            ...
            UpdateTaxPayerProfileOutputModel wsRes = ws.updateTaxPayerProfile(reqObject.nid, reqObject.authenKey, reqObject.name, reqObject.surname, reqObject.buildName, reqObject.roomNo
