...
public class RG_Save_Form extends BaseService{
    ...
    public String execute(VulcanHashParameter vhp) throws VulcanException {
        try{
            ...
            SaveRegisterationOutputModel wsRes = ws.saveRegisteration(reqObject.nid, reqObject.name, reqObject.surname, reqObject.birthDate, reqObject.passportNo, reqObject.countryCode, reqObject.fatherName, reqObject.motherName,reqObject.telephone, reqObject.telephoneExtension, reqObject.password, reqObject.questionId, reqObject.answer, reqObject.email, reqObject.moiFlag);
