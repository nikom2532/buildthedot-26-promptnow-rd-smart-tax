...
-(void)createGridview
{
    ...
    [_gridView setFrame:CGRectMake(0,footerLabel.frame.size.height+footerLabel.frame.origin.y, self.view.frame.size.width,screenHeight-footerHeight-titleBarHeight)];
