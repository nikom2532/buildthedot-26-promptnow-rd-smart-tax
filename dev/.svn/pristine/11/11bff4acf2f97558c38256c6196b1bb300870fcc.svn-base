...
import com.promptnow.rdsmart.api.model.UpdatePnd91CalTaxOutputModel.UpdatePnd91CalTaxData;
 ...
 * @author Promptnow11
 */
@BusinessProcess("FL_Update_Pnd91CalTax")
public class FL_Update_Pnd91CalTax extends BaseService{
    
    @JSON
    @Internal
    @Input(REQUEST)
    FL_Update_Pnd91CalTax_RequestModel reqObject = null; 
        
    @JSON
    @Render(RESPONSE)
    FL_Update_Pnd91CalTax_ResponseModel resObject = null;   
               
    @PreProcess
    public String preExecute(VulcanHashParameter vhp) throws VulcanException {
        jsonInput = getJSONMask(reqObject);
        resObject = new FL_Update_Pnd91CalTax_ResponseModel();
    ...
    public String execute(VulcanHashParameter vhp) throws VulcanException {
        try{
            ...
            UpdatePnd91CalTaxOutputModel wsRes = ws.updatePnd91CalTax(reqObject.nid, reqObject.authenKey, reqObject.language, reqObject.apiRefNo, reqObject.netTaxValue, reqObject.totTaxValue, reqObject.chkRefund, reqObject.partyCode, reqObject.smsTax);
            ...
            log.error(ex);
            Logger.getLogger(FL_Update_Pnd91CalTax.class.getName()).log(Level.SEVERE, null, ex);
            resObject.setCaseError(reqObject, FL_Update_Pnd91CalTax_ResponseModel.STATUS_ERROR, Message.get(reqObject.language,"GEN_ERR"));
        }finally {
...
class FL_Update_Pnd91CalTax_RequestModel extends CommonRequestModel{
...
class FL_Update_Pnd91CalTax_ResponseModel extends CommonResponseModel{
    public UpdatePnd91CalTaxData responseData;
    public FL_Update_Pnd91CalTax_ResponseModel() {
        super();
    }
    
    public FL_Update_Pnd91CalTax_ResponseModel(String status, String code, String msg) {
