...
public class GetAuthen {
	...
	public static M_Login getTempAuthen(String responseText) {
		try {
			JSONObject obj = new JSONObject(responseText);
			JSONObject objData = obj.getJSONObject(JSONElement.responseData);
			M_Login mLogin = getResponseData(objData.toString());
			return mLogin;
		} catch (JSONException e) {
			e.printStackTrace();
		}
	...
	public static M_Login getResponseData(String jsonObject) {
		M_Login mLogin = null;
