...
+(NSString*) formatEmailMask:(NSString*) source {
    ...
    NSString *host = [subTextArray objectAtIndex:0];
    NSString *com  = [subTextArray objectAtIndex:1];
    ...
    //-- merge new string
    NSLog(@"%@",[NSString stringWithFormat:@"%@%@%@@%@%@.%@",un1,un2,un3,ho1,ho2,com]);
    return [NSString stringWithFormat:@"%@%@%@@%@%@.%@",un1,un2,un3,ho1,ho2,com];
}
