...
public class GetPnd91 {
	...
	public P_Filling getPnd91(String responseText) {
		...
		try {
			...
			pFilling.responseCode = ConnectApi.getJsonString(objBig, JSONElement.responseCode);
			pFilling.responseMessage = ConnectApi.getJsonString(objBig, JSONElement.responseMessage);
			pFilling.responseError = ConnectApi.getJsonString(objBig, JSONElement.responseError);
			...
			pFilling.responseMessage = responseText;
			e.printStackTrace();
		}
		return pFilling;
	}
