...
@interface EfilingPrintDetailViewController : HeaderViewController <UIWebViewDelegate, MFMailComposeViewControllerDelegate, UITextFieldDelegate, ENSendEmailServiceServiceDelegate>
@property (nonatomic) ENSendEmailService *enSendEmailService;
