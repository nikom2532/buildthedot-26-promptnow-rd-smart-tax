...
#define kServiceUrl @"http://kimhun55.com/llnun/TestServiceRD/susanoo/check/checkConditionFillingFirst.json"

@implementation ENCheckConditionService {
    NSData *receivedData;
}
...
-(void)connectionDidFinishLoading:(NSURLConnection *)connection{
    ...
    [self.delegate responseENCheckConditionService:receivedData]; //send the data to the delegate
}
