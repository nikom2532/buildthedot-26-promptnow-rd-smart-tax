...
#define kServiceUrl @"http://kimhun55.com/llnun/TestServiceRD/mobile/register/changeOnlyPassword.json"
...
//    }
    if ([NSJSONSerialization isValidJSONObject:dictionary]) {
        ...
        [susanooObject sendSecuredRequestToService:@"fg-change-onlypassword.service" withJSONData:postData];
    }
...
-(void)susanooConnectionDidFinish:(SusanooResponse *)response
{
    ...
    [_delegate responseENChangeOnlyPasswordService:receivedData];
    [SVProgressHUD dismiss];
