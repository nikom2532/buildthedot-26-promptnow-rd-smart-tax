...
@interface EfilingAuthenUserViewController : HeaderViewController<UITextFieldDelegate,UIGestureRecognizerDelegate,ENConfirmRequestPasswordServiceDelegate>{
