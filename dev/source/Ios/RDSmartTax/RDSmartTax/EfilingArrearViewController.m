...
@interface EfilingArrearViewController ()<UIAlertViewDelegate,ENDeleteFormDelegate>
{
...
//            ENDeleteForm *endelete = [[ENDeleteForm alloc]init];
//            if (endelete) {
//                [endelete setDelegate:self];
//                [endelete requestENDeleteFormServiceWithSysRefNo:@""];
//            }
...
#pragma mark - ENDELETEFORM DELEGATE
