...
#define kServiceUrl @"http://kimhun55.com/llnun/TestServiceRD/susanoo/check/checkLoginFirst.json"

@implementation ENCheckLoginFirstService {
    NSData *receivedData;
}
...
-(void)connectionDidFinishLoading:(NSURLConnection *)connection{
    ...
    [self.delegate responseENCheckLoginFirstService:receivedData]; //send the data to the delegate
}
