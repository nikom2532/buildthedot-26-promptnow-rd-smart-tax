...
- (void) setFontStyle {
    ...
    self.pTitle.font  = [FontUtil fontWithFontSize:eFontSizeNormal Style:eFontStyleBold];
    self.pSubTitle.font  = [FontUtil fontWithFontSize:eFontSizeNormal Style:eFontStyleBold];
