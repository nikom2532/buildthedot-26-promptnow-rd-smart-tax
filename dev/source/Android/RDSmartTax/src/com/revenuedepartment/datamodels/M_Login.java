...
public class M_Login {
	...
	M_TaxPayerHash taxpayerHash = null;
	M_SpouseHash spouseHash = null;
	M_MarryHash marryHash = null;
	...
	public String getThaiNation() {
		return thaiNation;
	}

	public void setThaiNation(String thaiNation) {
		this.thaiNation = thaiNation;
	}

	public M_TaxPayerHash getTaxpayerHash() {
		return taxpayerHash;
	}

	public void setTaxpayerHash(M_TaxPayerHash taxpayerHash) {
		this.taxpayerHash = taxpayerHash;
	}

	public M_SpouseHash getSpouseHash() {
		return spouseHash;
	}

	public void setSpouseHash(M_SpouseHash spouseHash) {
		this.spouseHash = spouseHash;
	}

	public M_MarryHash getMarryHash() {
		return marryHash;
	}

	public void setMarryHash(M_MarryHash marryHash) {
		this.marryHash = marryHash;
	}
