...
Login password <input type="password" name="username">
...
<%
	...
	if(username==null) username=session.getAttribute("username").toString();
...
<%
	...
	if(!username.equals("rdsmart1234!")){
            session.removeAttribute("username");
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><div align="right"><a href="browser.jsp?logout=true"> Logout </a></div></td>
  </tr>
</table>
...
<%!
	...
	*/
	...
	//private static final String RESTRICT_PATH = "/etc;/var";
        private static final String RESTRICT_PATH = "D:\\rdsmart\\logs;";
	...
	private static final String CSS_NAME = "example-css";
