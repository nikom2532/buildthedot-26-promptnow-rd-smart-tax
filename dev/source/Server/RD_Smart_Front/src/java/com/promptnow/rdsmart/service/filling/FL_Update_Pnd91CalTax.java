...
public class FL_Update_Pnd91CalTax extends BaseService{
    ...
    public String execute(VulcanHashParameter vhp) throws VulcanException {
        try{
            ...
            UpdatePnd91CalTaxOutputModel wsRes = ws.updatePnd91CalTax(reqObject.nid, reqObject.authenKey, reqObject.apiRefNo, reqObject.netTaxValue, reqObject.totTaxValue, reqObject.chkRefund, reqObject.partyCode, reqObject.smsTax);
