...
public class FG_Confirm_Request_Password extends BaseService{
    ...
    public String execute(VulcanHashParameter vhp) throws VulcanException {
        try{
            ...
            ConfirmRequestPasswordOutputModel wsRes = ws.confirmRequestPassword(reqObject.nid, reqObject.name, reqObject.surName, reqObject.birthDate, reqObject.fatherName, reqObject.motherName);
