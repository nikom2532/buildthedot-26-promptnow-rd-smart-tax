...
import com.promptnow.rdsmart.api.model.GetFormPnd91OutputModel.GetFormPnd91Data;
 ...
 * @author Promptnow11
 */
@BusinessProcess("FL_Get_FormPnd91")
public class FL_Get_FormPnd91 extends BaseService{
    
    @JSON
    @Internal
    @Input(REQUEST)
    FL_Get_FormPnd91_RequestModel reqObject = null; 
        
    @JSON
    @Render(RESPONSE)
    FL_Get_FormPnd91_ResponseModel resObject = null;   
               
    @PreProcess
    public String preExecute(VulcanHashParameter vhp) throws VulcanException {
        jsonInput = getJSONMask(reqObject);
        resObject = new FL_Get_FormPnd91_ResponseModel();
    ...
    public String execute(VulcanHashParameter vhp) throws VulcanException {
        try{
            ...
            GetFormPnd91OutputModel wsRes = ws.getFormPnd91(reqObject.nid, reqObject.authenKey, reqObject.language);
            ...
            log.error(ex);
            Logger.getLogger(FL_Get_FormPnd91.class.getName()).log(Level.SEVERE, null, ex);
            resObject.setCaseError(reqObject, FL_Get_FormPnd91_ResponseModel.STATUS_ERROR, Message.get(reqObject.language,"GEN_ERR"));
        }finally {
...
class FL_Get_FormPnd91_RequestModel extends CommonRequestModel{
} 

class FL_Get_FormPnd91_ResponseModel extends CommonResponseModel{
    public GetFormPnd91Data responseData;
    public FL_Get_FormPnd91_ResponseModel() {
        super();
    }
    
    public FL_Get_FormPnd91_ResponseModel(String status, String code, String msg) {
