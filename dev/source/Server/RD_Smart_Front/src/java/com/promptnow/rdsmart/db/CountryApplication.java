...
String SQL = "SELECT CT_AMPHUR.AMPHUR_IDS,CT_AMPHUR.AMPHUR_NAME,CT_TOMBOL.TOMBOL_IDS,CT_TOMBOL.TOMBOL_NAME FROM CT_AMPHUR INNER JOIN CT_TOMBOL ON CT_AMPHUR.AMPHUR_IDS = CT_TOMBOL.AMPHUR_ID WHERE CT_AMPHUR.PROVINCE_ID='"+escapeSql(provinceID)+"' ORDER BY CT_AMPHUR.AMPHUR_NAME,CT_TOMBOL.TOMBOL_NAME";
