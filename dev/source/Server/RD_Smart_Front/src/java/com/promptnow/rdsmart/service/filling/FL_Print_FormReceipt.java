...
public class FL_Print_FormReceipt extends BaseService{
    ...
    public String execute(VulcanHashParameter vhp) throws VulcanException {
        try{
            ...
            PrintFormReceiptOutputModel wsRes = ws.printFormReceipt(reqObject.nid, reqObject.authenKey, reqObject.language, reqObject.formCode, reqObject.formType, reqObject.taxYear);
