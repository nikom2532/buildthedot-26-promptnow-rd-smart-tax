 ...
 * @author Promptnow11
 */
@BusinessProcess("FG_Confirm_Question")
public class FG_Confirm_Question extends BaseService{
    
    @JSON
    @Internal
    @Input(REQUEST)
    FG_Confirm_Question_RequestModel reqObject = null; 
        
    @JSON
    @Render(RESPONSE)
    FG_Confirm_Question_ResponseModel resObject = null;   
               
    @PreProcess
    public String preExecute(VulcanHashParameter vhp) throws VulcanException {
        jsonInput = getJSONMask(reqObject);
        resObject = new FG_Confirm_Question_ResponseModel();
    ...
    public String execute(VulcanHashParameter vhp) throws VulcanException {
        try{
            ...
            ConfirmQuestionOutputModel wsRes = ws.confirmQuestion(reqObject.nid, reqObject.language, reqObject.authenKey, reqObject.answer, reqObject.questionId);
            ...
            log.error(ex);
            Logger.getLogger(FG_Confirm_Question.class.getName()).log(Level.SEVERE, null, ex);
            resObject.setCaseError(reqObject, FG_Confirm_Question_ResponseModel.STATUS_ERROR, Message.get(reqObject.language,"GEN_ERR"));
        }finally {
...
class FG_Confirm_Question_RequestModel extends CommonRequestModel{
    public String answer;
    public String questionId;
} 

class FG_Confirm_Question_ResponseModel extends CommonResponseModel{
    
    public FG_Confirm_Question_ResponseModel() {
        super();
    }
    
    public FG_Confirm_Question_ResponseModel(String status, String code, String msg) {
