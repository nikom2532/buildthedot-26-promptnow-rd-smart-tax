...
public class KeyExchangeService extends BaseService{
    ...
    public String execute(VulcanHashParameter vhp) throws VulcanException {
        ...
        try {
            ...
            //fix key
            String FIX_KEY = "EC3CC66C2BD487787BDC18DC56331605A1E714DBC46173EAC50ACD7878AA2BBF";
            request.getSession().setAttribute(KEY_ENCRYPT, FIX_KEY);
            request.getSession().setAttribute(KEY_DECRYPT, FIX_KEY);
            resObject.key = key;
        } catch (Exception ex) {
